<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Newpassword.aspx.cs" Inherits="Newpassword" %>
            ...
            <table style="height: 201px" width="100%">
                <tr align="LEFT" valign="top">
                    <td height="20px" width="98%">
                        <fieldset height:"50"="" style="height: 181px">
            ...
            <tr align="center">
                <td>
                   <%-- <asp:Button ID="btn_Save" runat="server" CssClass="form93" 
                        onclick="btn_Save_Click" TabIndex="6" Text="Save" />--%>
                    <asp:Button ID="btnchange" runat="server" onclick="btnchange_Click"  CssClass="form93" 
