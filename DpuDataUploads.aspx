<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DpuDataUploads.aspx.cs" Inherits="DpuDataUploads" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddl_Plantname" runat="server" AutoPostBack="True" 
                    CssClass="tb10" Font-Bold="True" Font-Size="Medium" Height="30px" 
                    onselectedindexchanged="ddl_Plantname_SelectedIndexChanged" Width="198px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button5" runat="server" CssClass="form93" Font-Bold="False"   
                    ...
                    OnClientClick="return confirmationSave();" onclick="Button5_Click" Text="Show Data" 
                  TabIndex="6" />
           
                              
                <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False" 
                    Font-Size="X-Small" onclick="Button7_Click" TabIndex="6" Text="Inser Data" 
                    xmlns:asp="#unknown" />
