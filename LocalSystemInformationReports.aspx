<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LocalSystemInformationReports.aspx.cs" Inherits="LocalSystemInformationReports" %>
    ...
    <table  align="center" width="50%" style="border: thin ridge #008080">
        <tr align="center">
            <td align="center">
                <asp:Panel ID="Panel1" runat="server">
                    Date<asp:TextBox ID="txt_FromDate" runat="server" class="text1"
        ...
        <tr align="center">
            <td align="CENTER" style="width: 55%; text-align: center">
                ...
                <asp:Label ID="Label4" runat="server" Font-Size="Medium" Text="Plant Name" 
            ...
            <asp:GridView ID="GridView1" runat="server" 
                ...
                onrowcreated="GridView1_RowCreated" 
                 ...
                 <Columns>
                                       ...
                                       <asp:BoundField DataField="OffTime" HeaderText="Office System" 
                                           SortExpression="OffTime">
                                       <ControlStyle Width="300px" />
                                       <FooterStyle Width="300px" />
                                       <HeaderStyle Width="300px" />
                                       <ItemStyle Width="300px" />
                                       </asp:BoundField>
                                       <asp:BoundField DataField="weiTime" HeaderText="Weigher System" 
                                           SortExpression="weiTime">
                                       <ControlStyle Width="300px" />
                                       <FooterStyle Width="300px" />
                                       <HeaderStyle Width="300px" />
                                       <ItemStyle Width="300px" />
                                       </asp:BoundField>
                                       <asp:BoundField DataField="LabTime" HeaderText="Lab System" 
                                           SortExpression="LabTime" />
								   </Columns>
