<%@ Page Title="OnlineMilkTest|IncreaseDecreaseReport" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IncreaseDecrease.aspx.cs" Inherits="IncreaseDecrease" %>
...
<tr>
         ...
         <td width="25%" align="right">
             <asp:CheckBox ID="chk_IceDecAbstract" runat="server" 
                 Text="TotalAbstract" AutoPostBack="True" Checked="True" 
                 oncheckedchanged="chk_IceDecAbstract_CheckedChanged" />
         </td>
         <td width="5%"></td>
         <td width="45%">
...
<tr>
         ...
         <asp:Label ID="lbl_range" runat="server" Text="Select Type" ></asp:Label>
 ...
 <asp:DropDownList ID="ddl_Type" 
        runat="server" Width="80px" 
         AutoPostBack="True" 
                 Font-Bold="True" Font-Size="Medium" onselectedindexchanged="ddl_Type_SelectedIndexChanged" 
       >
     <asp:ListItem>MilkKg</asp:ListItem>
