...
using System.Text;
public partial class PlantMonthlyReport : System.Web.UI.Page
{
                ...
                string[] spldate=s.Split('/');
                   ...
                   ty=spldate[4];
                    ...
                    foreach (DataRow dfh in ReadData.Rows)
                    {
                        ...
                        try
                        {
                            GridView1.Rows[9].Cells[k].Text = dfh[35].ToString();//Nilpayment
                        }
                        catch
                        {
                        ...
                        GridView1.Rows[13].Cells[k].Text = dfh[12].ToString();//feed
                        GridView1.Rows[14].Cells[k].Text = dfh[15].ToString();//billadvance
                        GridView1.Rows[15].Cells[k].Text = dfh[13].ToString();//Netamount
                        GridView1.Rows[16].Cells[k].Text = dfh[33].ToString();//Transportamt
                      
                        double ts;
                        try
                        {
                            double transamt = Convert.ToDouble(dfh[33]);//Transportamt
                        ...
                        GridView1.Rows[24].Cells[k].Text = dfh[29].ToString();//gainmilkkg
                        GridView1.Rows[25].Cells[k].Text = dfh[30].ToString();//gainfatkg
                        GridView1.Rows[26].Cells[k].Text = dfh[31].ToString();//gainSnfkg
                        try
                        {
                             Fatgain = Convert.ToDouble(dfh[30]);
                             Snfgain = Convert.ToDouble(dfh[31]);
