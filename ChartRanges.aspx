<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChartRanges.aspx.cs" Inherits="ChartRanges" %>
...
<fieldset style="height: auto"><legend>TallyImport</legend>


    <label for="field3">
    <span>Plant Name <span class="required">*</span></span><label><asp:DropDownList 
        ID="ddl_Plantname" runat="server" AutoPostBack="True" CLASS="field3" 
            ...
            <td align="CENTER" >
               ...
               <asp:Button ID="Button5" runat="server" CssClass="form93" Font-Bold="False"   
                ...
                <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False" 
                    Font-Size="X-Small" onclick="Button7_Click" TabIndex="6" Text="Tally Export" 
                    xmlns:asp="#unknown" />
