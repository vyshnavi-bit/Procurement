<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentsBills.aspx.cs" Inherits="AgentsBills" %>
...
<fieldset  height:"50" style="height: auto"><legend>Agents Bill Copy</legend>
    ...
    <table class="style1">
        <tr>
            ...
            <td align="left">
                <label __designer:mapid="562" for="field3">
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False"   
                    Font-Size="X-Small"  xmlns:asp="#unknown"   
                    onclick="Button7_Click" Text="Back To Page" 
                  TabIndex="6" />
           </td>
            <td align="CENTER" >
