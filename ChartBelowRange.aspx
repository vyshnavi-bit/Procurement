<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChartBelowRange.aspx.cs" Inherits="ChartBelowRange" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table  align="center" width="50%" style="border: thin ridge #008080">
        <tr>
            <td style="text-align: center" class="style5" colspan="2">
                ...
                <asp:DropDownList ID="ddl_Plantname" runat="server" 
                     Font-Bold="True" Font-Size="Medium" Height="25px" Width="200px" 
                    CssClass="tb10">
                </asp:DropDownList>
        ...
        <tr>
            <td style="text-align: right" class="style5">
                ...
                From<asp:TextBox ID="txt_FromDate" runat="server" class="text1"
                                    Width="75px" Height="20px" ></asp:TextBox>
