<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PowerDetailsReport.aspx.cs" Inherits="PowerDetailsReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                     GenSetPowerDiesel Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#"> GenSetPowerDiesel Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i> GenSetPowerDiesel Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" 
                                                ...
                                                OnRowCreated="grdReports_RowCreated" OnRowDataBound="grdReports_RowDataBound">
                                                <Columns>
                                             ...
                                             <asp:GridView ID="GridView1" runat="server" 
                                                CssClass="table table-striped table-bordered table-hover" 
                                                OnRowCreated="grdReports_RowCreated1" OnRowDataBound="grdReports_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SNo.">
                                                        <ItemTemplate>
                                                            <%# Container.DataItemIndex + 1 %>
                                        ...
                                        <div>
                                             <asp:GridView ID="GridView2" runat="server" 
                                                CssClass="table table-striped table-bordered table-hover" 
                                                OnRowCreated="grdReports_RowCreated" 
