<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="cowupdation.aspx.cs" Inherits="cowupdation" %>
                                ...
                                <tr align="center">
                                    <td align="center" colspan="8">
                                        <strong>
                                            ...
                                            <asp:TextBox ID="txt_FromDate" runat="server" CssClass="ddl2" Width="125px"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txt_ToDate" runat="server" CssClass="ddl2" Width="125px"></asp:TextBox>
                                            ...
                                            <asp:DropDownList ID="ddl_Plantname" runat="server" Font-Bold="True" Font-Size="Small"
                                            ...
                                            <asp:Button ID="Button7" runat="server" BorderStyle="Groove" BorderWidth="1px" CssClass="buttonclass"
                                                ...
                                                font-size: small;" Text="Update" Width="89px" />
                                        </strong>
                                    </td>
                                </tr>
                                <tr>
