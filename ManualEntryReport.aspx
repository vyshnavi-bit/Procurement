<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ManualEntryReport.aspx.cs" Inherits="ManualEntryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                      ...
                      <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click" 
                          PostBackUrl="~/MANNUALSETTINGS.aspx" 
   ...
   <fieldset class="fontt">   
            <legend style="color: #3399FF">ManualEntry Report </legend>
    ...
    <table class="style3">
        <tr align="center">
            <td>
                ...
                &nbsp;<br /> <span class="style4"><strong>PLANT&nbsp;MANUAL&nbsp; ENTRY&nbsp; REPORT</strong></span>
