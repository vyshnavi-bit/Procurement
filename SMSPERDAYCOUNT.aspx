<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SMSPERDAYCOUNT.aspx.cs" Inherits="SMSPERDAYCOUNT" %>
    ...
    <table  align="center" width="50%" style="border: thin ridge #008080">
        <tr>
            <td align="CENTER" class="style1">
                SMS COUNTS&nbsp; FOR DAY</td>
        </tr>
        <tr>
            <td align="CENTER">
                <asp:Label ID="Label3" runat="server" Font-Size="Medium" Text="From"></asp:Label>
                <asp:TextBox ID="txt_FromDate" runat="server" class="text1" PopupPosition="BottomLeft"
        ...
        <tr align="center">
            <td>
                <asp:Label ID="Label5" runat="server" Text="Label" CssClass="button"></asp:Label>
            </td>
        </tr>
    </table>
            <br />
