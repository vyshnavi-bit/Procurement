<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoanRequestToOffice.aspx.cs" Inherits="LoanRequestToOffice" %>
    ...
    <td align="center">
            ...
            CssClass="table table-striped table-bordered table-hover" Font-Size="Small" 
                PageSize="20" AutoGenerateColumns="False" 
                               ...
                               onrowcreated="GridView2_RowCreated1">
                               ...
                               <Columns>
                                ...
                                <asp:Button ID="Button3" runat="server" CssClass="button" onclick="Button3_Click" 
                                    Text="Back" Font-Size="10px" Font-Bold="True" />
