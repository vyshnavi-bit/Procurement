<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DeductionRepeatProcess.aspx.cs" Inherits="DeductionRepeatProcess" %>
...
<fieldset  height:"50" style="height: auto"><legend>loan Jv Import</legend>
    ...
    <table class="style1" align="center">
        <tr>
            <td width=50% class="style2" style="text-align: right">
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="False"   
                    ...
                    OnClientClick="return confirmationSave();" onclick="Button5_Click" Text="Deduction Reprocess" 
                  TabIndex="6" />
