<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentMilkDashboard.aspx.cs" Inherits="AgentMilkDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table  align="center" width="100%" style="border: thin ridge #008080">
      ...
      <asp:DropDownList ID="ddl_AgentName" runat="server" 
                        Height="30px" CssClass="tb10" Width="230px">
      </asp:DropDownList>
                   ...
                   <tr align="CENTER">
                        <td  width="50%" valign="top">
                           <asp:GridView ID="GridView1" runat="server" 
                               CssClass="table table-striped table-bordered table-hover" Font-Bold="False" 
                               Font-Size="Small" PageSize="20" onrowcreated="GridView1_RowCreated">
                       ...
                       <td  width="50%" valign="top">
                           <asp:GridView ID="GridView4" runat="server" 
                               CssClass="table table-striped table-bordered table-hover" Font-Bold="False" 
                               Font-Size="Small" onrowcreated="GridView4_RowCreated" PageSize="20" 
                   ...
                   <tr align="CENTER">
                       <td  valign="top" WIDTH="50%" colspan="2">
                           <asp:GridView ID="GridView3" runat="server" 
                               CssClass="table table-striped table-bordered table-hover" Font-Size="Small" 
                               PageSize="20" onrowcreated="GridView3_RowCreated" 
                   ...
                   <tr align="center">
                       <td colspan="2">
                           ...
                           <asp:DropDownList ID="ddl_charttype" runat="server" AutoPostBack="True" 
                               ...
                               onselectedindexchanged="ddl_charttype_SelectedIndexChanged" Width="200px">
...
<center>
                           <div ID="visualization" style="width: 1000px; height: 500px;" style="padding-left:150px;">
                           </div>
