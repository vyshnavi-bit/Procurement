<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TallyReceipts.aspx.cs" Inherits="TallyReceipts" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
  <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" AsyncPostBackTimeout="3600">
    ...
    <section class="content-header">
        <h1>
            Tally Receipts<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Tally Reports</a></li>
            <li><a href="#">Tally Receipts</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Tally Receipts Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Tally Agent Receipts</span>
                                        </div>
                                        <div align="center">
