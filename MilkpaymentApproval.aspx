<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MilkpaymentApproval.aspx.cs" Inherits="MilkpaymentApproval" %>
...
<ContentTemplate>
    ...
    <table class="style1">
      ...
      <div class="form-style-9" style="height: 281px">
...
<fieldset  height:"50" style="height: auto"><legend>Milk Payment Approval </legend>
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txt_ToDate" runat="server" Enabled="False" Width="150px"></asp:TextBox>
        ...
        <tr>
            <td align="right">
                <strong style="font-size: small"><strong><span class="style2">Fil Name</span></strong><span 
                    style="text-align: right"><strong> </strong></span>Plant </strong>
            </td>
            <td align="right" width="50%">
                <label for="field3">
                <asp:DropDownList ID="ddl_filename" runat="server" CLASS="field4" Width="200px" 
 ...
 <center>
    <asp:Button ID="Button10" runat="server" CssClass="form93" Font-Bold="True" 
        Font-Size="10px" onclick="Button10_Click" 
        OnClientClick="return confirmationclose();" Text="Update" 
        xmlns:asp="#unknown" Visible="False" />
        </center>
   ...
   <br />
    ...
    <br />
                                               ...
                                               <asp:Button ID="Button11" runat="server" CssClass="form93" Font-Bold="True" 
                                                   Font-Size="10px" onclick="Button11_Click" 
                                                   OnClientClick="return confirmationDelete();" Text="Delete" 
                                                   xmlns:asp="#unknown" />
                                               <asp:Button ID="Button9" runat="server" CssClass="form93" Font-Bold="True" 
                                                   Font-Size="10px" onclick="Button9_Click" 
                                                   OnClientClick="return confirmatioUpdate();" Text="Update" 
                                                   xmlns:asp="#unknown" />
