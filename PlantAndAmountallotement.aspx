<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantAndAmountallotement.aspx.cs" Inherits="PlantAndAmountallotement" %>
...
<ContentTemplate>
    ...
    <table class="style1">
      ...
      <div class="form-style-9" style="height: 142px">
    ...
    <asp:Panel ID="news" runat="server">
                                                   ...
                                                   <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                    <Columns>
                                                       <asp:TemplateField HeaderText="SNo.">
                                                        ...
                                                        <asp:BoundField DataField="ExcessAmount" HeaderText="ExcessAmount" 
                                                            SortExpression="ExcessAmount" />
                                               ...
                                               <asp:GridView ID="GridView2" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   ...
                                                   <Columns>
                                                       ...
                                                       <asp:BoundField DataField="Updatedtime" HeaderText="AddedDate" 
                                               ...
                                               <asp:GridView ID="GridView3" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   Font-Size="14px" ForeColor="White" onrowcreated="GridView3_RowCreated" 
