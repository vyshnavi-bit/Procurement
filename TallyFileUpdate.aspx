<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TallyFileUpdate.aspx.cs" Inherits="TallyFileUpdate" %>
...
<fieldset   style="height:140px"><legend>loan Jv Import</legend>
...
<label for="field3"><span>Plant Name <span class="required">*</span></span><label><asp:DropDownList 
    ...
    <br />
      ...
      <span>File Date <span class="required">*</span></span><label>
    <asp:DropDownList ID="drpdate" runat="server" CLASS="field4" 
        onselectedindexchanged="drpdate_SelectedIndexChanged">
    </asp:DropDownList>
            
</label>

<span>File Name <span class="required">*</span></span><label>
    <asp:DropDownList ID="ddl_filename" runat="server" CLASS="field4" 
        onselectedindexchanged="drpdate_SelectedIndexChanged">
    </asp:DropDownList>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
                ...
                <asp:Button ID="Button9" runat="server" CssClass="form93" Font-Bold="False" 
                    Font-Size="X-Small" onclick="Button9_Click" TabIndex="6" Text="get File" 
                    Width="100px" xmlns:asp="#unknown" />
                </label>
           
                <asp:Button ID="Button8" runat="server" CssClass="form93" Font-Bold="False" 
                    Font-Size="X-Small" onclick="Button8_Click" TabIndex="6" Text="View Report" 
                    xmlns:asp="#unknown" />
           
               <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False"   
                    Font-Size="X-Small"  xmlns:asp="#unknown"   
                    onclick="Button7_Click" Text="Export" 
                  TabIndex="6" />
           </td>
            <td align="CENTER" >
