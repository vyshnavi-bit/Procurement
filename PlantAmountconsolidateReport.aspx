<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantAmountconsolidateReport.aspx.cs" Inherits="PlantAmountconsolidateReport" %>
...
<table style="height: 127px; width: 97%;">

<tr  ALIGN=LEFT>
<td WIDTH="98%" height="20px">

<fieldset  height:"50" style="height: auto"><legend>&nbsp;consolidategetreport</legend>


    <table width="100%">
        <tr>
            <td align="right" width="50%" colspan="2" style="width: 100%">
                <strong style="font-size: small">FromDate<asp:TextBox ID="txt_FromDate" 
                ...
                ToDate<asp:TextBox ID="txt_todate" runat="server" Enabled="False" Width="100px"></asp:TextBox>
                </strong></td>
        </tr>
        <tr>
...
<table style="width: 553px" >
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   Font-Size="14px" ForeColor="White" ShowFooter="True" Width="40%" onrowdatabound="GridView1_RowDataBound" 
