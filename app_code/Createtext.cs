...
public class Createtext
{
    ...
    public void Execute()
    {
        ...
        using (FileStream fs = new FileStream(name + ".txt", FileMode.Create))
        {
            ...
            ///////////////
            //pasword
            iTextSharp.text.pdf.PdfReader reader = new iTextSharp.text.pdf.PdfReader(name + ".txt".ToString());
            string MFileName = string.Empty;
            object TargetFile = name + ".txt".ToString();
                    ...
                    foreach (DataRow row1 in dt.Rows)
                    {
                        ...
                        if (f == 1)
                        {
                           // object tot;
                            ...
                            Footertable.AddCell(FormatSpace("Tmltr :" + " " + _Smltr.ToString()));
                            Footertable.AddCell(FormatHeaderPhrase("Tot :" + " " + _Smltr1.ToString()));
                            Footertable.AddCell(FormatHeaderPhrase("Afat :" + " " + _Afat.ToString()));
                            Footertable.AddCell(FormatHeaderPhrase("Asnf :" + " " + _Asnf.ToString()));
                            Footertable.AddCell(FormatHeaderPhrase("Arat :" + " " + _Arate.ToString()));
                            Footertable.AddCell(FormatHeaderPhrase("Tamt :" + " " + _Samt.ToString()));
                           ...
                           // Footertable.AddCell(FormatHeaderPhrase(" " + " " + "DEDUCTIONS :" + "FEED:" + _Feed.ToString() + " " + " " + " " + " " + " " + " " + "Ai:" + _Ai.ToString() + " " + " " + " " + " " + " " + " " + "TotalDeduction:" + _TotDedu.ToString()));
                            ...
                            Addtable.AddCell(FormatHeaderPhrase("CarAmt :" + " " + _CartageAmt.ToString()));
                            ...
                            _TotAdd = (_CartageAmt);
                            Addtable.AddCell(FormatHeaderPhrase( _TotAdd.ToString()));
                            ...
                            Dedtable.AddCell(FormatHeaderPhrase("FEED :" + " " + _Feed.ToString()));
                            Dedtable.AddCell(FormatHeaderPhrase("Ai :" + " " + _Ai.ToString()));
                            Dedtable.AddCell(FormatSpace("Ai :" + " " + _Ai.ToString()));
                            Dedtable.AddCell(FormatHeaderPhrase("Totdeductions :"));
                            _TotDedu = (_Feed + _Ai);
                            Dedtable.AddCell(FormatHeaderPhrase( _TotDedu.ToString()));
                            ...
                            ADtable.AddCell(FormatSpace("WORDS :"));
                           ...
                           // ADtable.AddCell(new PdfPCell(new Phrase("WORDS :" + _Netamt)) { Colspan = 5 });
                            ...
                            ADtable.AddCell(FormatSpace(words + "Rupees Only".Trim()));
                            ADtable.DefaultCell.HorizontalAlignment = Element.ALIGN_RIGHT;
                            ADtable.AddCell(FormatSpace("DEDUCTIONS :"));
                            ADtable.AddCell(FormatSpace("DEDUCTIONS :"));
                            ADtable.AddCell(FormatSpace("DEDUCTIONS :"));
                            ADtable.AddCell(FormatHeaderPhrase("NetAmt :"));
                            
                            ADtable.AddCell(FormatHeaderPhrase(_Netamt.ToString()));
            ...
            else
            {
                ...
                foreach (DataRow row in table.Rows)
                {
                    ...
                    if ((i > j) && (i <= k))
                    {
                        ...
                        ////
                        _prdate = Convert.ToDateTime(row[0].ToString());
                        pdfTable.AddCell(FormatPhrase(_prdate.ToString()));
                        _session = row[1].ToString();
                        pdfTable.AddCell(FormatPhrase(_session));
                        _milkltr = row[2].ToString();
                        pdfTable.AddCell(FormatPhrase(_milkltr));
                ...
                //tot = row1[8].ToString();                            
                // _Feed = Convert.ToDouble(row1[9].ToString());
                //_Ai = Convert.ToDouble(row1[10].ToString());
                PdfPTable Footertable = new PdfPTable(7);
                Footertable.DefaultCell.Padding = 4;
                Footertable.WidthPercentage = 85; // percentage                                
                Footertable.DefaultCell.BorderWidth = 0;
                ...
                Footertable.AddCell(FormatSpace("Tmltr :" + " " + _Smltr.ToString()));
                Footertable.AddCell(FormatSpace("Tmltr :" + " " + _Smltr.ToString()));
                Footertable.AddCell(FormatHeaderPhrase("Tot :" + " " + _Smltr.ToString()));
                Footertable.AddCell(FormatHeaderPhrase("Afat :" + " " + _Afat.ToString()));
                Footertable.AddCell(FormatHeaderPhrase("Asnf :" + " " + _Asnf.ToString()));
                Footertable.AddCell(FormatHeaderPhrase("Arat :" + " " + _Arate.ToString()));
                Footertable.AddCell(FormatHeaderPhrase("Tamt :" + " " + _Samt.ToString()));
               ...
               // Footertable.AddCell(FormatHeaderPhrase(" " + " " + " " + "FEED:" + _Feed.ToString() + " " + " " + " " + " " + " " + " " + "Ai:" + _Ai.ToString() + " " + " " + " " + " " + " " + " " + "TotalDeduction:" + _TotDedu.ToString()));
                ...
                //csp.RIGHT_BORDER = 0;
                //csp.BorderWidth = 0;
                //ADtable.AddCell(new PdfPCell(new Phrase("WORDS :" + _Feed)) { Colspan = 5 });
                //ADtable.AddCell(new PdfPCell(new Phrase("WORDS :" + _Netamt)) { Colspan = 5 });
                _Netamt = ((_Samt + _TotAdd) - _TotDedu);
                int word=Convert.ToInt32(_Netamt);
                string words=string.Empty;
    ...
    {
        return new Phrase(value, FontFactory.GetFont(FontFactory.HELVETICA, 6, BaseColor.WHITE));
    }

    private static Phrase FormatPhrase(string value)
    {
        return new Phrase(value, FontFactory.GetFont(FontFactory.HELVETICA,6));
    }

    private static Phrase FormatHeaderPhrase(string value)
    {
        return new Phrase(value, FontFactory.GetFont(FontFactory.HELVETICA,6, Font.NORMAL, BaseColor.BLACK));
    }
