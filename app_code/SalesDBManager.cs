...
public class SalesDBManager
{
    ...
    //  public string UserName = "";
      ...
      {
         // conn.ConnectionString = @" SERVER=49.50.65.160;DATABASE=AMPS;UID=sa;PASSWORD=Vyshnavi123;";
          //conn.ConnectionString = @" SERVER=49.50.65.160;DATABASE=AMPS;UID=sa;PASSWORD=WHHWYE%23@^#%;";
          conn.ConnectionString = @" SERVER=182.18.162.51;DATABASE=AMPS;UID=sa;PASSWORD=Vyshnavi@123;";
        //conn.ConnectionString = @" SERVER=49.50.65.161;DATABASE=AMPS;UID=sa;PASSWORD=GH*&^%R76Ri7*&%^);";
      }
