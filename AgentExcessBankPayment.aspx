<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentExcessBankPayment.aspx.cs" Inherits="AgentExcessBankPayment" %>
...
<fieldset  height:"50" style="height: auto"><legend>Agent Excess Bank Payment</legend>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <%--<asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="False"   
                    ...
                    onclick="Button5_Click" Text="View Report" 
                  TabIndex="6" />--%>
               ...
               <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False"   
                    Font-Size="X-Small"  xmlns:asp="#unknown"   
                    onclick="Button7_Click" Text="Tally Export" 
                  TabIndex="6" />
           </td>
            <td align="CENTER" >
