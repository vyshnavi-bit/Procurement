...
using System.Data;
public partial class GensetPowerDieselReport : System.Web.UI.Page
{
    SqlCommand cmd;
    string Branchid = "";
    SalesDBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //cmd.Parameters.Add("@todate", GetHighDate(todate));
            //cmd.Parameters.Add("@plnat_code", Plant_Code);
            //DataTable dtsuperwise2 = vdm.SelectQuery(cmd).Tables[0];
            ...
            //cmd.Parameters.Add("@todate", GetHighDate(todate));
            //cmd.Parameters.Add("@plnat_code", Plant_Code);
            //DataTable dtsuperwise3 = vdm.SelectQuery(cmd).Tables[0];
            if (dtsuperwise1.Rows.Count > 0)
            {
                ...
                foreach (DataRow drsuper in dtsuperwise1.Rows)
                {
                    ...
                    //newrow["DiselCLLiters"] = drsuper["DispCloLtrs"].ToString();
    ...
    protected void grdReports_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
           ...
           // HeaderCell2.Text = ddl_Plantname.Text + ":Garbar Details:" + "From:" + txt_FromDate.Text + "To:" + txt_ToDate.Text;
            HeaderCell2.Text = "GENERATOR   READING";
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            // HeaderCell2.Text = ddl_Plantname.Text + ":Garbar Details:" + "From:" + txt_FromDate.Text + "To:" + txt_ToDate.Text;
            HeaderCell3.Text = "DAILY GENERATOR Details";
