<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LiveMilkAnalyzes.aspx.cs" Inherits="LiveMilkAnalyzes" %>
...
<div class="form-style-9" style="height: 166px">
...
<fieldset  height:"50" style="height: auto"><legend>RouteWise Payment Details </legend>
    ...
    <table class="style1">
        <tr>
            <td align="right" width="35%">
                <strong><span class="style2">Bill Date</span></strong><span 
                    style="text-align: right" class="style2"><strong> </strong>
                </span>
            </td>
            ...
            <td align="left"  width="35%">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                    RepeatDirection="Horizontal" Width="70%" style="text-align: CENTER">
 ...
 <table width=100%>
    ...
    <div WIDHT="100%" style="margin-bottom: 0px">
        <asp:Literal ID="lt" runat="server"></asp:Literal>
    </div>
    <center>
    <div id="chart_div" WIDTH="100%">
    </div>
    </center>
...
<Triggers>
    <asp:PostBackTrigger ControlID="Button6" />
        ...
        <asp:PostBackTrigger ControlID="lt" />
</Triggers>
</asp:UpdatePanel>
