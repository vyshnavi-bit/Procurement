<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ModifySubAgentList.aspx.cs" Inherits="ModifySubAgentList" %>
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   ...
                                                   onrowcreated="GridView1_RowCreated" AutoGenerateColumns="False" DataKeyNames="Tid" 
                                                   ...
                                                   <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                                    <Columns>
                                                       ...
                                                       <asp:TemplateField HeaderText="SNo.">
                                                        ...
                                                        <asp:BoundField DataField="Agent_id" HeaderText="canno" ReadOnly="True" 
