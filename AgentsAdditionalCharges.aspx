<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentsAdditionalCharges.aspx.cs" Inherits="AgentsAdditionalCharges" %>
...
<ContentTemplate>
    ...
    <table class="style1">
      ...
      <div class="form-style-9" style="height: 369px">
...
<fieldset  height:"50" style="height: auto"><legend>Chilling Plant Data Modify And 
    Delete </legend>
    ...
    <table width="100%">
        <tr>
            <td align="right" width="50%">
                <strong style="font-size: small">From&nbsp; Date<asp:TextBox ID="txt_FromDate" 
                    runat="server" Enabled="False" Width="100px"></asp:TextBox>
            ...
            <td align="left" width="50%">
                <strong style="font-size: small">To Date<asp:TextBox ID="txt_todate" 
                    runat="server" Enabled="False" ontextchanged="txt_todate_TextChanged" 
        ...
        <tr>
            <td align="center" colspan="2" width="70%" >
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" Height="20px" 
                    ...
                    style="font-size: medium; font-family: Andalus" AutoPostBack="True">
                    <asp:ListItem Value="1">PlantWise</asp:ListItem>
                    <asp:ListItem Value="2">RouteWise</asp:ListItem>
                    <asp:ListItem Value="3">AgentWise</asp:ListItem>
                    <asp:ListItem Value="4">FatKgUpdate</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            <td align="right" width="50%">
                ...
                <asp:Label ID="Label4" runat="server" 
                    style="font-size: small; font-weight: 700" Text="ExcesAmount"></asp:Label>
                </span>
            </td>
            <td align="left">
                <asp:TextBox ID="TextBox1" runat="server"   MaxLength="8"  onkeypress="javascript:return isNumber1(event)"    ></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right" width="50%">
                <strong><span class="style2"></span></strong><span style="text-align: right">
                <strong></strong>
                <asp:Label ID="Label2" runat="server" 
                    style="font-size: small; font-weight: 700" Text="Route Name"></asp:Label>
                </span>
            </td>
            <td align="left">
                <label for="field3">
                <asp:DropDownList ID="ddl_routeid" runat="server" CLASS="field4" Width="200px">
                </asp:DropDownList>
                </label>
            </td>
        </tr>
        <tr>
            <td align="right" width="50%">
                ...
                <asp:Label ID="Label3" runat="server" 
                    style="font-size: small; font-weight: 700" Text="Agent Id"></asp:Label>
                </span>
            </td>
            <td align="left">
                <label for="field3">
                <asp:DropDownList ID="ddl_Agentid" runat="server" CLASS="field4" Width="200px">
                </asp:DropDownList>
                </label>
            </td>
        </tr>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="true"   
                ...
                <asp:Button ID="Button10" runat="server" CssClass="form93" Font-Bold="true"      Font-Size="X-Small" onclick="Button10_Click" 
                    OnClientClick="return confirmationupdate();" TabIndex="6" Text="Update" xmlns:asp="#unknown" />
           
                              
                <asp:Button ID="Button11" runat="server" CssClass="form93" Font-Bold="true" 
                    Font-Size="X-Small" onclick="Button11_Click" 
                    OnClientClick="return confirmationupdate();" TabIndex="6" Text="FatkgUpdate" 
                    xmlns:asp="#unknown" />
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   Font-Size="14px" ForeColor="White" ShowFooter="True" Width="40%" 
