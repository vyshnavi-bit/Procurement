<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SapDataStatus.aspx.cs" Inherits="SapDataStatus" %>
...
<table  width=60% style="height: 93px">
                ...
                <fieldset height:"50"="" style="height: auto">
                    ...
                    <table align="center" width=60%>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label1" runat="server" style="font-size: small" Text="Sessions"></asp:Label>
                                <asp:DropDownList ID="ddl_shift" runat="server" Width="150px">
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False"   
                    ...
                    onclick="Button7_Click" Text="Show" 
                  TabIndex="6" />
           </td>
            <td align="CENTER" >
                   ...
                   <tr align="center">
                       <td valign=top class="style6">
                           <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                               Font-Size="12px" ForeColor="White" GridLines="Both" 
                       ...
                       <td valign=top align=center>
                           <asp:GridView ID="GridView3" runat="server" CssClass="gridcls" Font-Bold="True" 
                               Font-Size="12px" ForeColor="White" GridLines="Both" 
                               onrowcreated="GridView3_RowCreated" Width="35%">
                               <EditRowStyle BackColor="#999999" />
                               <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                               <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" Font-Italic="False" 
                                   Font-Names="Raavi" Font-Size="Small" ForeColor="Black" />
                       ...
                       <td  valign=top  width=75%>
                           <asp:GridView ID="GridView4" runat="server" CssClass="gridcls" Font-Bold="True" 
                               Font-Size="12px" ForeColor="White" GridLines="Both" 
                               onrowcreated="GridView4_RowCreated" Width="35%">
                               <EditRowStyle BackColor="#999999" />
                               <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                               <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" Font-Italic="False" 
                                   Font-Names="Raavi" Font-Size="Small" ForeColor="Black" />
