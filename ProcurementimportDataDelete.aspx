<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProcurementimportDataDelete.aspx.cs" Inherits="ProcurementimportDataDelete" %>
...
<ContentTemplate>
    ...
    <table class="style1">
      ...
      <div class="form-style-9" style="height: 279px">
...
<fieldset  height:"50" style="height: auto"><legend>Chilling Plant Data Modify And 
    ...
    <table class="style1">
        ...
        <tr>
            <td align="right" width="50%">
                <strong><span class="style2">Date</span></strong><span style="text-align: right"><strong> </strong>
                </span>
            </td>
            <td align="left">
                <asp:TextBox ID="txt_FromDate" runat="server" Width="180px" 
        ...
        <tr>
            <td  align="center"  width="100%" style="height: auto; width: 0%;">
                <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" 
                    Height="20px" onselectedindexchanged="RadioButtonList2_SelectedIndexChanged" 
                    RepeatDirection="Horizontal" style="font-size: small; font-weight: 700;" 
                    Width="200px">
                    <asp:ListItem Value="1">AM</asp:ListItem>
                    <asp:ListItem Value="2">PM</asp:ListItem>
                </asp:RadioButtonList>
            </td>
            <td align="center" style="height: auto; width: 50%;" width="100%">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="RadioButtonList1_SelectedIndexChanged" 
                    RepeatDirection="Horizontal" style="font-size: small; font-weight: 700;" 
                    Width="200px">
                    <asp:ListItem Value="1">Single Agent</asp:ListItem>
                    <asp:ListItem Value="2">All Agent</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            <td align="right" width="50%">
                ...
                <strong><span class="style2"></span></strong><span class="style2" 
                    style="text-align: right"><strong> </strong></span>
            </td>
            <td align="left">
                <label for="field3">
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   Font-Size="14px" ForeColor="White" ShowFooter="True" Width="60%" 
    ...
    <br />
                                               <asp:Button ID="Button9" runat="server" CssClass="form93" Font-Bold="True"  xmlns:asp="#unknown"  
                                                   Font-Size="10px" onclick="Button9_Click"  OnClientClick="return confirmationclose();"
                                                   Text="Delete" />
