<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TallyPayments.aspx.cs" Inherits="TallyPayments" %>
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Tally Payments Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">Tally Payments</span>
                                        </div>
                                        <div align="center">
