<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantAndAmountallotementForFinance.aspx.cs" Inherits="PlantAndAmountallotementForFinance" %>
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" 
                                                   Font-Bold="True"  Caption="Banking Pament Details For Finance" 
                                               ...
                                               <asp:GridView ID="GridView2" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   ...
                                                   ShowFooter="True" Width="60%" AutoGenerateSelectButton="True" 
