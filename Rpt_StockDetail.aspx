<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Rpt_StockDetail.aspx.cs" Inherits="Rpt_StockDetail" %>
...
PopupControlID="UpdateProgress" BackgroundCssClass="modalPopup" />
 <asp:UpdatePanel ID="UpdatePanel1" runat="server"    >
        ...
        <div align="right"> <asp:HyperLink ID="HyperLink1" runat="server" CssClass="fontt" 
                                            NavigateUrl="~/DeductionEntry.aspx">DeductionEntry</asp:HyperLink></div>
   ...
   <td align="LEFT">
       ...
       <asp:CheckBox ID="Chk_AllorStock"  Text="Allotment/Stock" runat="server" 
           Font-Size="12px" Font-Bold="true" Checked="True" />

       <asp:RadioButtonList ID="rbtLstReportItems" runat="server" AutoPostBack="True"  Font-Size="12px" Font-Bold="true"
           onselectedindexchanged="rbtLstReportItems_SelectedIndexChanged" 
           RepeatDirection="Horizontal" RepeatLayout="Table">
           <asp:ListItem Text="Godown" Value="1"></asp:ListItem>
           <asp:ListItem Text="Plant" Value="2"></asp:ListItem>
       </asp:RadioButtonList>
       <asp:DropDownList ID="ddl_PlantName" runat="server" Font-Bold="true" 
           Font-Size="12px" Height="24px" Width="140px">
       </asp:DropDownList>
               ...
               <asp:Label ID="lbldate" runat="server" 
                   style="font-weight: 700; text-align: center;" Width="500px" CssClass="style11"></asp:Label></center>
                        ...
                        <td colspan="4" style="width: 68%" width="34%" align="center">
                                ...
                                <asp:GridView ID="GodownStockDetails" runat="server" AutoGenerateColumns="true" 
                                ...
                                <SortedDescendingHeaderStyle BackColor="#00547E" />
                                    ...
                                    <asp:GridView ID="PlantStockDetails" runat="server" BackColor="White" 
