...
public partial class Rpt_PlantpermonthOverAllData : System.Web.UI.Page
{
    public string ccode;
    public string pcode;
        ...
        if (IsPostBack != true)
        {
            ...
            {               
              ...
              //  managmobNo = Session["managmobNo"].ToString();
                ...
                if (rd_MilkTypeType.SelectedItem == null)
                {
                    Valmilktype = "2";
            ...
            if ((Session["Name"] != null) && (Session["pass"] != null))
            {
              ...
              //  managmobNo = Session["managmobNo"].ToString();   
                ...
                else
                {
                    if (rd_MilkTypeType.SelectedItem != null)
                    {
                        Lbl_MilkTypeType.Text = rd_MilkTypeType.SelectedItem.Value;

                        if (Lbl_MilkTypeType.Text == "1")
                        {
                            Valmilktype = "1";                           
                        }
                        else
    ...
    private void LoadReportDisplayItems()
    {
        try
        {
            ...
            string[] strarr1 = new string[] { "Period", "TotalMkgs", "TotalMltrs", "PerDayMilkMltrs", "LtrCost", "kg_Fat", "AvgFat ", "kg_Snf", "AvgSnf", "NillPayments", "MilkValueAmout", "BillAdv", "AiAdv", "FeedAdv", "CanAdv", "Recovery", "LoanAdv", "loanperltrdedu", "NetBillAmount", "TransportAmount", "Transport Ltr Cost", "Total Solid TS(Kg Fat Rate)", "Procure Vale TS Rate", "Transport TS Rate", "Chilling Cost Per Ltr", "Chilling Cost TS Rate", "Total TS Rate", "kg milk gain", "kg fat gain", "kg snf gain", "Total Fat+Snf Gain", "Fat Gain % perLtr", "Snf Gain % perLtr", "Total Gain % perLtr", "AvgFat GainFat %", "AvgSnf GainSnf %", "Total AvgGainSnf %", "Fat Cost ", "Snf Cost ", "Total Fat+Snf Cost", "FatCost Ltrs", "SnfCost Ltrs", "Total Fat+Snf Cost Ltrs", "Fat & Snf PerTS", "Total Cost", "Net_TSRate", "TopGainpercent", "TopLtrcost", "TopTransportLtrcost" };//49-ORG
    ...
    private void LoadPlantName()
    {
        ...
        {            
            ...
            ds = null;           
            ds = BllPlant.LoadPlantNameMilktype(ccode.ToString(), Valmilktype);            
            if (ds != null)
            {       
    ...
    private void LoadPlantwisepermonthOverAllDataResultORG()
    {
        try
        {
            ...
            using (conn = new SqlConnection(dbConnStr))
            {
                ...
                {
                    //1 means TS
                    sqlCmd.Parameters.AddWithValue("@TsorCosting", 1);
                }
                else
                {
                    //2 means TS
                    sqlCmd.Parameters.AddWithValue("@TsorCosting", 2);
                }
                SqlDataAdapter da = new SqlDataAdapter(sqlCmd);
                da.Fill(dts);
                ...
                if (rd_RportViewType.SelectedItem != null)
                {
                    ...
                    if (Lbl_selectedReportItem.Text == "Horizontal")
                    {
                        ...
                        //    ksdt.Columns.Add(ksdc);
                        //    ksdc = new DataColumn("Fat Cost ");
                        //    ksdt.Columns.Add(ksdc);
                        //    ksdc = new DataColumn("Snf Cost ");
                        //    ksdt.Columns.Add(ksdc);
                        ...
                        // START ADDING ROWS
                        //string[] strarr1 = new string[] { "Period", "Scans", "Smkg", "Smltr", "Sfatkg", "Ssnfkg", "Aclr", "Samt", "SInsentAmt", "Scaramt", "SSplBonus", "SClaimAount", "SBilladv", "SAi", "SFeed", "Scan", "SRecovery", "Sinstamt", "SLoanClobal", "TotAdd", "STotdedu", "SLoanAmt", "SRoundoff", "SNetAmt" };//24 Total Solid TS
                        if (Valmilktype == "1")
                        {
                            //string[] strarr1 = new string[] { "Period", "TotalMkgs", "TotalMltrs", "PerDayMilkMltrs", "LtrCost", "kg_Fat", "AvgFat ", "kg_Snf", "AvgSnf", "NillPayments", "MilkValueAmout", "BillAdv", "AiAdv", "FeedAdv", "CanAdv", "Recovery", "LoanAdv", "loanperltrdedu", "NetBillAmount", "TransportAmount",  "Total Solid TS(Kg Fat Rate)", "ProcureVale TSRate", "Transport TS Rate", "Chilling Cost Per Ltr", "ChillCost TSRate", "Total TS Rate", "kg milk gain", "kg fat gain", "kg snf gain", "Tot Fat+Snf Gain", "Fat Gain % perLtr", "Snf Gain % perLtr", "Total Gain % perLtr", "AvgFat GainFat %", "AvgSnf GainSnf %", "Total AvgGainSnf %", "Fat Cost ", "Snf Cost ", "Total Fat+Snf Cost", "FatCost Ltrs", "SnfCost Ltrs", "Tot Fat+Snf CostLtrs", "Fat & Snf PerTS", "Total Cost", "Net_TSRate", "TopGainpercent", "TopLtrcost", "TopTransportLtrcost" };//52
                            string[] strarr1 = new string[] { "PerDayMilkMltrs", "AvgFat ", "AvgSnf", "Total Solid TS(Kg Fat Rate)", "LtrCost", "ProcureVale TSRate", "Transport Ltr Cost", "Transport TS Rate", "ChillCost TSRate", "Total TS Rate", "Fat Gain % perLtr", "Snf Gain % perLtr", "Total Gain % perLtr", "AvgFat GainFat %", "AvgSnf GainSnf %", "Total AvgGainSnf %","FatCost Ltrs", "SnfCost Ltrs", "Tot Fat+Snf CostLtrs", "Fat & Snf PerTS", "Total Cost", "Net_TSRate" };//0-23
                    ...
                    else if (Lbl_selectedReportItem.Text == "Vertical")
                    {
                        ...
                        if (Valmilktype == "1")
                        {
                            string[] strarr1 = new string[] { "Period", "TotalMkgs", "TotalMltrs", "PerDayMilkMltrs", "LtrCost", "kg_Fat", "AvgFat ", "kg_Snf", "AvgSnf", "NillPayments", "MilkValueAmout", "BillAdv", "AiAdv", "FeedAdv", "CanAdv", "Recovery", "LoanAdv", "loanperltrdedu", "NetBillAmount", "TransportAmount", "Transport Ltr Cost", "Total Solid TS(Kg Fat Rate)", "ProcureVale TSRate", "Transport TS Rate", "Chilling Cost Per Ltr", "ChillCost TSRate", "Total TS Rate", "kg milk gain", "kg fat gain", "kg snf gain", "Tot Fat+Snf Gain", "Fat Gain % perLtr", "Snf Gain % perLtr", "Total Gain % perLtr", "AvgFat GainFat %", "AvgSnf GainSnf %", "Total AvgGainSnf %", "Fat Cost ", "Snf Cost ", "Total Fat+Snf Cost", "FatCost Ltrs", "SnfCost Ltrs", "Tot Fat+Snf CostLtrs", "Fat & Snf PerTS", "Total Cost", "Net_TSRate", "TopGainpercent", "TopLtrcost", "TopTransportLtrcost" };//52
                            if (counts > 0)
                            {
                                int i = 0;
                        ...
                        {
                           // string[] strarr1 = new string[] { "PerDayMilkMltrs", "LtrCost", "kg_Fat", "AvgFat ", "kg_Snf", "AvgSnf", "NillPayments", "MilkValueAmout", "BillAdv", "AiAdv", "FeedAdv", "CanAdv", "Recovery", "LoanAdv", "loanperltrdedu", "NetBillAmount", "TransportAmount", "Transport Ltr Cost", "Total Solid TS(Kg Fat Rate)", "ProcureVale TSRate", "Transport TS Rate", "Chilling Cost Per Ltr", "ChillCost TSRate", "Total TS Rate", "kg milk gain", "kg fat gain", "kg snf gain", "Tot Fat+Snf Gain", "Fat Gain % perLtr", "Snf Gain % perLtr", "Total Gain % perLtr", "AvgFat GainFat %", "AvgSnf GainSnf %", "Total AvgGainSnf %", "Fat Cost ", "Snf Cost ", "Total Fat+Snf Cost", "FatCost Ltrs", "SnfCost Ltrs", "Tot Fat+Snf CostLtrs", "Fat & Snf PerTS", "Total Cost", "Net_TSRate", "TopGainpercent", "TopLtrcost", "TopTransportLtrcost" };//52
                            string[] strarr1 = new string[] { "Period", "TotalMkgs", "TotalMltrs", "PerDayMilkMltrs", "LtrCost", "kg_Fat", "AvgFat ", "MilkValueAmout", "BillAdv", "AiAdv", "FeedAdv", "CanAdv", "Recovery", "LoanAdv", "loanperltrdedu", "NetBillAmount", "TransportAmount", "Transport Ltr Cost", "Kg Fat Rate", "Plant OverHeads PerLtr", "OverHeads Amount", "kg milk gain", "kg fat gain", "Fat Gain % perLtr", "AvgFat GainFat %", "Fat Cost ", "FatCost Ltrs", "Net_TSRate", "TopGainpercent", "TopLtrcost", "TopTransportLtrcost" };//31-ORG
                            if (counts > 0)
                            {
                                int i = 0;
    ...
    protected void rd_MilkTypeType_SelectedIndexChanged(object sender, EventArgs e)
    {
        rdmilktype();
        
    }

    private void rdmilktype()
    {
        try
        {
            if (rd_MilkTypeType.SelectedItem != null)
