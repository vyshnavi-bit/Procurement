<%@ Page Title="" Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="compressioReport.aspx.cs" Inherits="compressioReport" %>
...
&nbsp;<asp:ToolkitScriptManager ID="ToolkitScriptManager1" EnablePageMethods="true" runat="server" />
    ...
    <section class="content-header">
        <h1>
            Compression AND MilkRechillingReport<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Compression AND MilkRechillingReport</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Compression AND MilkRechillingReport
                </h3>
            </div>
            <div class="box-body">
                                    ...
                                    <div id="divPrint">
                                        <div style="width: 100%;">
                                           <%-- <div style="width: 13%; float: left;">
                                            ...
                                            <div align="center">
                                                ...
                                                <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                <br />
                                                <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Compression AND MilkRechillingReport</span><br />
                                            </div>
                                          ...
                                          Compression Running Details 
                                            ...
                                            Milk Rechilling Details
                                                <asp:GridView ID="grdmilkrecheller" runat="server" ForeColor="Black" Width="100%" CssClass="gridcls"
                                                    GridLines="Both" Font-Bold="true"  OnDataBinding="grdmilkrecheller_DataBinding">
                                                    <EditRowStyle BackColor="#999999" />
                                                    <FooterStyle BackColor="999999" Font-Bold="False" ForeColor="Black" />
                                                    <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                                        Font-Names="Raavi" Font-Size="Small" />
