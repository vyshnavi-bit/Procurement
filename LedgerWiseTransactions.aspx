<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LedgerWiseTransactions.aspx.cs" Inherits="LedgerWiseTransactions" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Ledger Wise Transactions<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Ledger Wise Transactions</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Ledger Wise Transactions Details
                </h3>
            </div>
            <div class="box-body">
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <span style="font-size: 18px; font-weight: bold; padding-left: 37%; text-decoration: underline;
                                            color: #0252aa;">Ledger Details Report</span>
                                        <div>
                                            <div style="width: 40%; float: left; padding-left: 7%;">
                                             <span style="font-weight: bold;">BranchName: </span>
                                                <asp:Label ID="lblbranchname" runat="server" Style="font-size: 20px;" ForeColor="Red"
                                                    Text=""></asp:Label>
                                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                <span style="font-weight: bold;">Ledger Name: </span>
                                                <asp:Label ID="lblLedger" runat="server" Style="font-size: 11px;" ForeColor="Red"
                                                    Text=""></asp:Label>
                                            </div>
