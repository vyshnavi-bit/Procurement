<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CashPaymentToBank.aspx.cs" Inherits="CashPaymentToBank" %>
...
<ContentTemplate>
    ...
    <table class="style1">
      ...
      <div class="form-style-9" style="height: 184px">
...
<fieldset  height:"50" style="height: auto"><legend>Cash To Bank File Uploading </legend>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <asp:DropDownList ID="ddl_BillDate" runat="server" CLASS="field4" 
                    onselectedindexchanged="ddl_BillDate_SelectedIndexChanged" Width="175px">
                </asp:DropDownList>
                </label>
            </td>
        </tr>
    ...
    <asp:Panel ID="news" runat="server">
                                                    ...
                                                    <Columns>
                                                       <asp:TemplateField HeaderText="SNo.">
                                                        ...
                                                        <asp:BoundField DataField="Ifsc_code" HeaderText="Ifsccode" 
                                                         ...
                                                         <asp:BoundField DataField="Agent_AccountNo" HeaderText="Agent_AccountNo" 
                                                            SortExpression="Agent_AccountNo" />   
                                                               <asp:BoundField DataField="UpdatingTime" HeaderText="UpdatingTime" 
                                                            SortExpression="UpdatingTime" />  
                                                              <asp:TemplateField>
                                        <ItemTemplate>
                                        ...
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="chkHeader" runat="server" />
                                               ...
                                               <asp:Button ID="Button10" runat="server" CssClass="form93" Font-Bold="False" 
                                                   Font-Size="X-Small" onclick="Button10_Click" TabIndex="6" Text="Update" 
                                                   Visible="False" />
