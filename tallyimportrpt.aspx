<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="tallyimportrpt.aspx.cs" Inherits="tallyimportrpt" %>
                    ...
                    <div class="form-style-9" style="height: auto">
                        ...
                        <table style="width: 555px">
                            <tr width="100%" align="center">
                                <td align="CENTER">
                                    <asp:button id="Button5" runat="server" cssclass="form93" font-bold="False" font-size="X-Small" text="Get Report" tabindex="6" OnClick="Button2_Click"/>
                                    
                                    <asp:button id="Button7" runat="server" cssclass="form93" font-bold="False" font-size="X-Small"
                                        xmlns:asp="#unknown" text="Tally Export" tabindex="6" />
                                </td>
                                <td align="CENTER">
                                    &nbsp;
                                </td>
