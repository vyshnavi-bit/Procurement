<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssignDpuAgent.aspx.cs" Inherits="AssignDpuAgent" %>
        ...
        <tr align="LEFT">
            <td height="20px" width="98%">
                <fieldset height:"50"="" style="height: auto">
                    <legend>Dpu&nbsp; Agent Update</legend>
                    <table align="center" class="style1">
                        ...
                        <tr>
                            <td  align="center" colspan="2" width="50%">
                                <asp:RadioButtonList ID="dpustatus" runat="server" 
                                    RepeatDirection="Horizontal" Width="200px">
                                    <asp:ListItem Value="1">Dpu</asp:ListItem>
                                    <asp:ListItem Value="0">NonDpu</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr align="center">
