<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubAgentsMaster.aspx.cs" Inherits="SubAgentsMaster" %>
    ...
    <td>
        <div class="form-style-9" style="height: 400px">
            <div class="form-style-3">
                <table width="100%" style="height: 298px">
                    <tr align="LEFT" valign="top">
                        <td height="20px" width="98%">
                            <fieldset height:"50"="" style="height: 280px">
                                <legend>Sub Agnet Master </legend>
                                <table  width=100%>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddl_Agentid" runat="server" CssClass="tb10" 
                                                Font-Bold="True" Font-Size="Medium" Height="30px" Width="205px" 
                                                AutoPostBack="True" onselectedindexchanged="ddl_Agentid_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: small; text-align: right;">
                                            SubAgentName</td>
                                        <td>
                                            <asp:TextBox ID="txt_subagent" runat="server" Width="190px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: small; text-align: right;">
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList runat="server" CssClass="tb10" Font-Bold="True" 
                                                Font-Size="Medium" Height="30px" Width="205px" ID="ddl_bankname" 
                                                AutoPostBack="True">
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td style="font-size: small; text-align: right;">
                                            A/c number</td>
                                        <td>
                                            <asp:TextBox ID="txt_accno" runat="server" 
                                    ...
                                    <tr>
                                        <td style="font-size: small; text-align: right;">
                                            Ifsc code</td>
                                        <td>
                                            <asp:TextBox ID="txt_ifsc" runat="server" Width="190px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
