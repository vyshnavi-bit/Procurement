<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReceiptBook.aspx.cs" Inherits="ReceiptBook" %>
        ...
        <ContentTemplate>
            <div>
                            ...
                            <div>
                                <table id="tbltrip">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtReceiptNo" runat="server" CssClass="txtsize"></asp:TextBox>
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                           <td style="font-size: 10px; padding-left: 24%; text-decoration: underline;">
                             <%--<asp:Label ID="lblVoucherType" runat="server" Font-Bold="true" Font-Size="16px" ForeColor="#0252aa"
                                    Text=""></asp:Label>--%>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <asp:Label ID="lblAmount" runat="server" class="mylbl12"
                                    Text=""></asp:Label>
                                </td>
                                <td style="width: 20%;">
                                </td>
                                <td style="width: 55%;">
                                   For  <asp:Label ID="lblSignTitle" runat="server" class="mylbl12"
                                    Text=""></asp:Label>
                                    <br />
                                    <br />
                                    Signature
                ...
                <%--<asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="~/exporttoxl_utility.ashx">Export to XL</asp:HyperLink>--%>
                <br />
