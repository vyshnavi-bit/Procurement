<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CostingReports.aspx.cs" Inherits="CostingReports" %>
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                                               ...
                                               <asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="True" 
                                                   Font-Size="20px" ForeColor="White" ShowFooter="True" Width="60%" onrowdatabound="GridView1_RowDataBound" 
