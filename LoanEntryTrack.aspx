<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoanEntryTrack.aspx.cs" Inherits="LoanEntryTrack" %>
...
<fieldset  height:"50" style="height: auto"><legend>loan Tracking</legend>


    <table class="style1">
        <tr>
            <td align="right" width="50%">
                    Bill Date<span style="text-align: right"> </span>
                </td>
            <td align="left">
                <label for="field3">
    <asp:DropDownList ID="ddl_BillDate" runat="server" CLASS="field4" Width="160px">
    </asp:DropDownList>
   ...
   <br />
    ...
    <td align="center">
                               ...
                               CssClass="gridcls" Font-Bold="True" 
                                                   ForeColor="White" GridLines="Both" onrowcreated="GridView1_RowCreated" 
