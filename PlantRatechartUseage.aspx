<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantRatechartUseage.aspx.cs" Inherits="PlantRatechartUseage" %>
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >
  ...
  <div class="legagentsms">
   ...
   <asp:Label ID="Label6" runat="server" Font-Size="Large" ForeColor="Green" 
       ...
       <br />
   <asp:GridView ID="GridView3" runat="server"  HeaderStyle-BackColor="#CCFF99" Font-Size="13px" Font-Bold="False" 
           ForeColor="#CC3300">
       </asp:GridView>
   </td>
   </tr>
