<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RateCalculate.aspx.cs" Inherits="RateCalculate" %>
...
<fieldset  height:"50" style="height: auto"><legend>Data Rate calculations</legend>
    ...
    <table align="center" class="style1">
        ...
        <tr>
            <td class="style2" colspan="2">
                Date<asp:TextBox ID="txt_FromDate" runat="server" Width="120px"></asp:TextBox>
                ...
                <asp:Label ID="Label1" runat="server" Text="Sessions"></asp:Label>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="False"   
                    ...
                    OnClientClick="return confirmationSave();" onclick="Button5_Click" Text="Rate Calculate" 
                  TabIndex="6" />
