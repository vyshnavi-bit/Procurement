<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sappayment.aspx.cs" Inherits="sappayment" %>
...
<table width=100% style="height: 213px; width: 100%;">

<tr  ALIGN=LEFT>
<td WIDTH="98%">

<fieldset style="height: 143px" ><legend>TallyImport</legend>
...
<label for="field3"><span>Plant Name <span class="required">*</span></span><label><asp:DropDownList 
   ...
   <label><span>Bill Date <span class="required">*</span></span><label>
    ...
    <label for="field5"><span>SAP Bank Payment<span class="required">*</span></span><label><asp:DropDownList ID="ddl_sapbankpayment" runat="server" class="field5">
        <asp:ListItem Value="1212009">SBI_Chennai</asp:ListItem>
        <asp:ListItem Value="1212001">HDFC_Punabaka</asp:ListItem>
        <asp:ListItem Value="2115004">KOTAK_Chennai</asp:ListItem>
        <asp:ListItem Value="1212013">HDFC_Kavali</asp:ListItem>
        </asp:DropDownList>
        </label>
             ...
             <asp:Button ID="Button7" runat="server" CssClass="form93" Font-Bold="False" 
                 Font-Size="X-Small" onclick="Button7_Click" TabIndex="6" Text="Insert Payment Data" 
                 xmlns:asp="#unknown" />
