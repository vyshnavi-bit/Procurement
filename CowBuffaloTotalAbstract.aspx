<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CowBuffaloTotalAbstract.aspx.cs" Inherits="CowBuffaloTotalAbstract" %>
...
<table  align="center" width="50%" style="border: thin ridge #008080">
        ...
        <tr align="center">
            <td align="CENTER" colspan="2" style="width: 55%; ">
                ...
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                    ...
                    <asp:ListItem Value="3">CowBuffalo</asp:ListItem>
                </asp:RadioButtonList>
