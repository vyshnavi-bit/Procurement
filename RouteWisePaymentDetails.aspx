<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RouteWisePaymentDetails.aspx.cs" Inherits="RouteWisePaymentDetails" %>
...
<fieldset  height:"50" style="height: auto"><legend>RouteWise Payment Details </legend>
...
<table style="width: 515px" >
   ...
   <br />
    ...
    <asp:Panel ID="news" runat="server">
                               ...
                               CssClass="gridcls" Font-Bold="True" ShowFooter="True"
                                                   ForeColor="White" onrowcreated="GridView2_RowCreated" 
                                                   onrowdatabound="GridView2_RowDataBound" Width="50%" 
                               Font-Size="14px" AutoGenerateColumns="False" 
									   ...
									   <asp:TemplateField HeaderText="SNo.">
										   <ItemTemplate>
											   <%# Container.DataItemIndex + 1 %>
                                                       ...
                                                       <asp:BoundField DataField="Route_ID" HeaderText="Route_ID" ItemStyle-Width="150px"
                                                           SortExpression="Route_ID" >
                                                           <ItemStyle Width="150px" />
                                                       </asp:BoundField>
                                                       <asp:BoundField DataField="Route_Name" HeaderText="Route_Name" ItemStyle-Width="150px"
                                                           SortExpression="Route_Name" >
                                                           <ItemStyle Width="150px" />
                                                       </asp:BoundField>
                                                       <asp:BoundField DataField="Netamount" HeaderText="Bank Amount" ItemStyle-Width="150px"
                                                           SortExpression="Netamount" >
                                                           <ItemStyle Width="150px" />
                                                       </asp:BoundField>
                                                       <asp:BoundField DataField="CashAmount" HeaderText="CashAmount" ItemStyle-Width="150px"
                                                           SortExpression="CashAmount" >
                                                           <ItemStyle Width="150px" />
                                                       </asp:BoundField>
                                                       ...
                                                       <asp:BoundField DataField="PaidAmout" HeaderText="PaidAmout"  ItemStyle-Width="150px"
                                                           SortExpression="PaidAmout " >
								                           <ItemStyle Width="150px" />
                                                       </asp:BoundField>
								                          <asp:BoundField DataField="BalanceAmount" HeaderText="BalanceAmount"  ItemStyle-Width="150px"
