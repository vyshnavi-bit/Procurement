<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChartComparison.aspx.cs" Inherits="ChartComparison" %>
    ...
    <table  align="center" width="50%" style="border: thin ridge #008080">
        ...
        <tr align="center">
            <td align="CENTER" style="width: 55%; ">
                ...
                <asp:Label ID="Label5" runat="server" Font-Size="Medium" Text="Bill Date"></asp:Label>
                   ...
                   <tr valign=top>
                       <td>
                           <asp:GridView ID="GridView1" runat="server" 
                               ...
                               onrowdatabound="GridView1_RowDataBound" Font-Size="14px">
                               <Columns>
                       ...
                       <td valign=top>
                           <asp:GridView ID="GridView2" runat="server" 
                               ...
                               onrowdatabound="GridView2_RowDataBound" Font-Size="14px">
                               <Columns>
                                   <asp:TemplateField HeaderText="SNo.">
                                       <ItemTemplate>
                                           <%# Container.DataItemIndex + 1 %>
                       ...
                       <td valign=top>
                           <asp:GridView ID="GridView3" runat="server" 
                               ...
                               onrowdatabound="GridView3_RowDataBound" Font-Size="14px">
                               <Columns>
                                   <asp:TemplateField HeaderText="SNo.">
                                       <ItemTemplate>
                                           <%# Container.DataItemIndex + 1 %>
