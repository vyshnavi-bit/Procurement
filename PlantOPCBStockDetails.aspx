<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantOPCBStockDetails.aspx.cs" Inherits="PlantOPCBStockDetails" %>
          ...
          <center>
           <asp:Panel id="pnlContents" align="center" runat = "server">
            <asp:GridView ID="GridView1" runat="server"  
               ...
               <asp:Button ID="Button7" runat="server" CssClass="button" Font-Bold="True" 
                   Font-Size="10px" onclick="Button7_Click" Text="Send Sms" />
    </asp:Panel>
    </center>
