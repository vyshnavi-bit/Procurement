<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChartAssigntoAgent.aspx.cs" Inherits="ChartAssigntoAgent" %>
...
<fieldset  ><legend>loan Jv Import</legend>


    <table class="style1">
        <tr>
            <td width=50% style="text-align: right">
                <span class="style2">Plant</span><span 
                    style="font-size: small; text-align: right;"> Name <span class="required">
                </span></span></td>
            <td>
                <label for="field3">
        ...
        <tr>
            <td style="text-align: right">
                ...
                <span style="font-size: small">Agent Name <span class="required">
                </td>
            <td>
                <label for="field3">
        ...
        <tr>
            <td>
                <asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="False" 
                    ...
                    OnClientClick="return confirmationSave();" TabIndex="6" Text="Rate Calculate" 
                    xmlns:asp="#unknown" />
            </td>
        </tr>
    </table>
