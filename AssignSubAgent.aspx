<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssignSubAgent.aspx.cs" Inherits="AssignSubAgent" %>
        ...
        <tr align="LEFT">
            <td height="20px" width="98%">
                <fieldset height:"50"="" style="height: auto">
                    <legend>Sub Agent Update</legend>
                    <table align="center" class="style1">
                        ...
                        <tr>
                            <td class="style4" width="50%">
                                <asp:Label ID="Label3" runat="server" Text="Agent Id" CssClass="style5"></asp:Label>
                            </td>
                            <td>
                                <label for="field3">
                                <asp:DropDownList ID="ddl_agentid" runat="server" AutoPostBack="True" 
                                    CLASS="field3" onselectedindexchanged="ddl_agentid_SelectedIndexChanged" 
                                    Width="150px">
                                </asp:DropDownList>
                                </label>
                            </td>
                        ...
                        <tr>
                            <td class="style3" width="50%">
                                <asp:Label ID="Label4" runat="server" Text="Sub Agent" CssClass="style7" 
                                    style="font-weight: 700"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txt_agent" runat="server" MaxLength="8" 
                                    onkeypress="javascript:return isNumber1(event)"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </fieldset>
