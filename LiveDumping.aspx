<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiveDumping.aspx.cs" Inherits="LiveDumping" %>
 ...
 <div style="width: 70%; float: left;">
        ...
        PopupPosition="TopRight">
               ...
               <span style="font-size: 18px; font-weight: bold; color: #0252aa;"><asp:Label ID="ABsnf" runat="server" ></asp:Label></span>
                 ...
                 <tr>
                 <td width="30%" align="center">
                 <span style="font-size: 18px; font-weight: bold; color: green;">COW</span>
                </td>
                <td width="30%" align="center">
                <span style="font-size: 18px; font-weight: bold; color: #0252aa;"><asp:Label ID="totalcMilk" runat="server" ></asp:Label></span>
                </td>
               <td width="30%" align="center">
               <span style="font-size: 18px; font-weight: bold; color: #0252aa;"><asp:Label ID="Acfat" runat="server" ></asp:Label></span>
                </td>
               <td width="30%" align="center">
               <span style="font-size: 18px; font-weight: bold; color: #0252aa;"><asp:Label ID="Acsnf" runat="server" ></asp:Label></span>
                </td>
                </tr>                 
                </table>           
    ...
    <span style="font-size: 20px; font-weight: bold; color: Red;">
        ...
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Blue" Font-Bold="true"  NavigateUrl="~/DashBoard.aspx">DashBoard</asp:HyperLink>
        </span>
            </td>
            </tr>
            </table>
                ...
                <div></div>
                  ...
                  <asp:GridView ID="grdLivepro" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                          ...
                          onselectedindexchanged="grdLivepro_SelectedIndexChanged">
       ...
       <asp:TemplateField HeaderText = "RouteName" ItemStyle-Width="150">     
        <ItemTemplate>
                <asp:HyperLink CssClass="linkNoUnderline" ForeColor="Brown" ID="HyperLink3" runat="server" NavigateUrl='<%# string.Format("~/Cs1.aspx?Id={0}&Name={1}&Country={2}", 
                    HttpUtility.UrlEncode(Eval("RouteName").ToString()), HttpUtility.UrlEncode(Eval("RouteName").ToString()), HttpUtility.UrlEncode(Eval("RouteName").ToString())) %>'
                    Text='<%# Eval("RouteName") %>' />
            </ItemTemplate>       
        </asp:TemplateField>                     
