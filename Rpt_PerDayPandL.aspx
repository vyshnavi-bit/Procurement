<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Rpt_PerDayPandL.aspx.cs" Inherits="Rpt_PerDayPandL" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </asp:TableCell>
                        ...
                        <table border="0" width="100%" id="table4" cellspacing="1" align="center">
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <asp:RadioButtonList ID="rd_RportViewType" runat="server" RepeatDirection="Horizontal"
                                        RepeatLayout="Table">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button ID="btn_Get" runat="server" BackColor="#00CCFF" BorderStyle="Double"
                                        Font-Bold="True" ForeColor="White" OnClick="btn_Get_Click" Text="Get" />
                                    <asp:Button ID="btnPrintCurrent" runat="server" BackColor="#00CCFF" BorderStyle="Double"
                                        Font-Bold="True" ForeColor="White" OnClientClick="return PrintPanel();" Text="Print" />
                                </td>
                                <td width="12%">
                                </td>
                            </tr>
            ...
            <asp:Panel ID="pnlContents" runat="server">
                <div align="left">
                    ...
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label
                        ID="Lbt_Title" runat="server" Text="ALL PLANTWISE MONTHLY PROCUREMENT BILL REPORT"
                    ...
                    <asp:GridView ID="gvCustomers" CssClass="fontfam" runat="server" AutoGenerateColumns="True"
                        AllowPaging="True" HeaderStyle-BackColor="Silver" PageSize="50" Font-Size="12px">
                    </asp:GridView>
                    <br />
                </div>
            </asp:Panel>
