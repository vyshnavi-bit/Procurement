<%@ Page Title="OnlineMilkTest|RemarksModify" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Remarksadminmodify.aspx.cs" Inherits="Remarksadminmodify" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server"  >
            ...
            <br />   
             <asp:DropDownList ID="ddl_Plantcode" AutoPostBack="true" runat="server" Visible="false"></asp:DropDownList>
                ...
                <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="Save"  BackColor="#6F696F"  ForeColor="White"  Width="50px" Height="26px" OnClientClick="return confirm('Do u want to Save the Records?');"/>
                <br /> 
                </div>
                        ...
                        <table width="100%">
                            <tr align ="center" >                               
                                <td ID="checkpanel" class="style2" >
                                    <asp:Panel runat="server"  Height="800px"    width="100%">                                
