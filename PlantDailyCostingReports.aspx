<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PlantDailyCostingReports.aspx.cs" Inherits="PlantDailyCostingReports" %>
        ...
        <tr width="100%" align=center>
            <td align="CENTER" >
               ...
               <asp:Button ID="Button6" runat="server" CssClass="form93" Font-Bold="False"   
                ...
                <span class="blink_me">
                <asp:Label ID="Label1" runat="server"   Text="HAIIIIIII" BorderColor="#FF5050" 
...
<asp:GridView ID="GridView1" runat="server" CssClass="gridcls" Font-Bold="false" 
