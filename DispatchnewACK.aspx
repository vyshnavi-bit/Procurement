<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DispatchnewACK.aspx.cs" Inherits="DispatchnewACK" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <asp:LinkButton ID="LinkButton1" runat="server" 
         style="font-weight: 700; text-align:left" CausesValidation="False" 
                     PostBackUrl="~/Dispatchnew.aspx">BACK</asp:LinkButton>
             </td>
         </tr>
     </table>
     </right>
            ...
            <tr>
                <td align="center" class="style7">
                    <asp:Label ID="Label1" runat="server"   ForeColor="#FF8000" 
                        ...
                        Text="Despatch Acknowledgement Form"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                        ...
                        <tr>
                            ...
                            <td class="style7">
                                <asp:TextBox ID="txt_avail" runat="server" Height="21px" 
                                    ontextchanged="txt_avail_TextChanged" style="text-align: right" 
        ...
        <table class="style4">
            <tr>
                ...
                <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                                <asp:BoundField DataField="DcNumber" HeaderText="DcNumber" 
                                    SortExpression="DcNumber" />
                <asp:BoundField DataField="Ack_milkkg" HeaderText="MilkKg" SortExpression="Ack_milkkg" />
                <asp:BoundField DataField="Ack_fat" HeaderText="Fat" SortExpression="Ack_fat" />
                <asp:BoundField DataField="Ack_snf" HeaderText="Snf" SortExpression="Ack_snf" />                   
